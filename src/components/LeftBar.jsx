...
const LeftBar = () => {
  ...
  return (
    <>
      ...
      {/* error */}
      {error && <p className="text-danger text-center mt-6">{error}</p>}
      ...
      {!error && !loading && profile && (
        <>
          ...
          {/* Collegamenti (Home) */}
          <Container className="mx-2 mb-2 mt-0 rounded bg-white p-0 w-100 w-lg-50 border border-1 border-secondary-subtle d-none d-md-block">
            ...
            <Row className="pt-3 text-start ps-3 align-items-start">
              ...
              <Col>
                <p className="fs-6 mb-2">
                  <strong>
                    <i className="bi bi-bookmark-fill me-1"></i> Elementi
                    salvati
                  </strong>
                </p>
                <p className="fs-6 mb-2">
                ...
                <p className="fs-6 mb-2">
                  <strong>
                    <i className="bi bi-calendar me-1"></i> Eventi
                  </strong>
                </p>
              </Col>
            </Row>
