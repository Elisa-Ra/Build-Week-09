...
const IMAGE_URL =
  "https://img.freepik.com/foto-gratuito/foto-del-modello-di-consistenza-della-pietra_58702-16052.jpg?semt=ais_hybrid&w=740&q=80"
...
const Consigliati = () => {
  return (
    <div className="card p-3 shadow-sm mx-auto">
      ...
      <div className="d-flex align-items-center py-3">
        ...
        <div>
          ...
          <div className="text-secondary small">
            ...
            with industry expertise to solve real-world challenges.
          </div>
        </div>
